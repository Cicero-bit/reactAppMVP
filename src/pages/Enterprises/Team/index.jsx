        ...
        <div className='flex place-content-between'>
          <div className='flex flex-col gap-2 mx-10 w-1/2'>
            ...
            <div className='bg-white rounded-l-lg px-4 h-10 content-center'>
              ...
              <input type='search' id="filtrar" className='bg-white w-100 max-w-1/3 h-10 rounded-r-lg px-1' placeholder="Pesquise"></input>
            </div>
          </div>
          <div className='mx-10'>
            <button className='bg-blue-300 shadow-md rounded-lg py-4 px-10'>Criar novo time</button>
          </div>
        </div>
        ...
        <div className='grid xl:grid-cols-4 gap-10'>
          <div className='flex flex-1'>
            <div className="bg-white w-100 px-10 py-5 flex flex-col gap-5 shadow-md rounded-lg ">
              ...
              <div className='bg-cover h-40 shrink'
              style={{
              ...
              <div className='flex flex-col gap-2'>
                  ...
                  <div className='flex place-content-between'>
                    <h2 className='bg-yellow-400 border-2 border-yelow-600 text-yellow-900 font-bold px-2 rounded-lg'>Editar</h2>
                    <h2 className='bg-red-400 border-2 border-red-500 text-red-900 font-bold px-2'>Deletar</h2>
                  </div>
              </div>
